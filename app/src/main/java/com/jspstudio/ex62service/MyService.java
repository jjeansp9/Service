package com.jspstudio.ex62service;
...
// 서비스는 4대 컴포넌트여서 AndroidManifest.xml에 등록해야함
public class MyService extends Service { // Service는 Context를 상속받음
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // 이 곳에서 foreground로 서비스한다고 명시 해야만 함
        ...
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel channel= new NotificationChannel("ch1", "Ex62", NotificationManager.IMPORTANCE_HIGH);
        ...
        // 알림창을 클릭하여 서비스 제어버튼이 있는 MainActivity가 실행되도록
        ...
        startForeground(1, notification); // 포어그라운드에서 돌아가려면 퍼미션도 필요함(매니페스트에서 작성)
